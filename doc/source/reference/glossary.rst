...
See: `ASE Documentation <https://wiki.fysik.dtu.dk/ase/>`_
...
Energy difference between reactant/product and saddle point. Forward barrier = E\ :sub:`saddle`\ - E\ :sub:`reactant`\. Reverse barrier = E\ :sub:`saddle`\ - E\ :sub:`product`\.
...
See: `eOn Website <https://eon.zih.tu-dresden.de/>`_
...
Atomic unit of energy. 1 Hartree = 27.211386245988 eV. Symbol: E\ :sub:`h`\.
...
See: `JAX Documentation <https://jax.readthedocs.io/>`_
...
Approximation method for Gaussian Processes using inducing points. Reduces O(n\ :sup:`3`\) to O(m\ :sup:`2`\ n) where m << n.
...
See: `OPI GitHub <https://github.com/faccts/opi>`_
...
See: `ORCA Website <https://www.faccts.de/orca/>`_
...
Root Mean Square Deviation. Measure of structural difference. RMSD = sqrt(sum((r1-r2)\ :sup:`2`\)/N).
...
- `Tutorials <../tutorials/index.rst>`_ - Learn how to use these concepts

- `How-to Guides <../howto/index.rst>`_ - Solve problems with these concepts

- `Explanation <../explanation/index.rst>`_ - Understand these concepts in depth
