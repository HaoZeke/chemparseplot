...
- Draws star markers (=*=, size=200) with black edge at zorder=50
- Colors peaks by energy using =coolwarm= colormap
...
All other parameters are passed through to the underlying NEB plot functions.
