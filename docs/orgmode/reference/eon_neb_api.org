...
| =additional_atoms_data= | =list[NebOverlayStructure]= | Typed overlay records with =atoms=, =r=, =p=, and =label= |
| =sp_data= | =NebOverlayStructure= or =None= | Explicit saddle-point overlay record |
