...
** Ecosystem Overview
   ~chemparseplot~ is part of the ~rgpkgs~ suite (hub: ~rgpycrumbs~).

- CON/convel: [[https://github.com/lode-org/readcon-core][readcon-core]] (PyPI: ~readcon~)
- Hub: [[https://github.com/HaoZeke/rgpycrumbs][rgpycrumbs]] · inputs: [[https://github.com/HaoZeke/pychum][pychum]] · engine: [[https://eondocs.org][eOn]]
