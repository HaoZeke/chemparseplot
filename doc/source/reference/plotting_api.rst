...
plot\ :sub:`landscape`\ \ :sub:`surface`\(
    ax, rmsd\ :sub:`r`\, rmsd\ :sub:`p`\, grad\ :sub:`r`\, grad\ :sub:`p`\, z\ :sub:`data`\,
    step\ :sub:`data`\=None, method="grad\ :sub:`matern`\", rbf\ :sub:`smooth`\=None,
    cmap="viridis", show\ :sub:`pts`\=True, variance\ :sub:`threshold`\=0.05,
    project\ :sub:`path`\=True, extra\ :sub:`points`\=None, n\ :sub:`inducing`\=None,
    xlim=None, ylim=None, basis=None,
    auto\ :sub:`thin`\=False, max\ :sub:`surface`\ \ :sub:`points`\=64,
    surface\ :sub:`fit`\=None,
)
...
Defaults keep historical behaviour (~auto\ :sub:`thin`\=False=).
...
``plot_structure_strip(ax, atoms_list, labels=None, zoom=0.3, rotation``"0x,90y,0z", theme\ :sub:`color`\="black", max\ :sub:`cols`\=6, renderer="xyzrender", label\ :sub:`ax`\=None)=
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
``plot_structure_inset(ax, atoms, x, y, xybox, rad, zoom=0.4, rotation``"0x,90y,0z", arrow\ :sub:`props`\=None, renderer="ase")=
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
``plot_orca_neb_landscape(neb_data, output, *, width=5.37, height=5.37, dpi=200, method``"grad\ :sub:`matern`\", project\ :sub:`path`\=True)=
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
``plot_optimization_landscape(ax, rmsd_a, rmsd_b, grad_a, grad_b, z_data, *, label_mode``"optimization", project\ :sub:`path`\=True, method="grad\ :sub:`matern`\", cmap="viridis", z\ :sub:`label`\="Energy (eV)", \*\*surface\ :sub:`kwargs`\)=
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
``plot_optimization_profile(ax, iterations, energies, *, eigenvalues=None, ax_eigen=None, color``"#004D40", eigen\ :sub:`color`\="#FF655D")=
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

Plots energy (and optionally eigenvalue) vs iteration.

``plot_convergence_panel(ax_force, ax_step, dat_df, *, force_col``"convergence", step\ :sub:`col`\="step\ :sub:`size`\", iter\ :sub:`col`\="iteration", color="#004D40")=
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
- `How-to: Create Publication Figures <../howto/create_neb_figures.rst>`_

- `ORCA NEB API Reference <orca_neb_api.rst>`_

- `eOn NEB API Reference <eon_neb_api.rst>`_
